...
const buildImages = () => gulp
  ...
  .pipe(responsive({
    '**/*.{png,jpg}': [
      { width:     40, rename: { suffix: '-lq' } },
      { width:    150, rename: { suffix: '-150' } },
      { width:    250, rename: { suffix: '-250' } },
      ...
      { width:   1440, rename: { suffix: '-1440' } },
      { width:   1600, rename: { suffix: '-1600' } },
